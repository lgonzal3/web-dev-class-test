...
while ( $wp_query->have_posts() ) : $wp_query->the_post();
    ...
    {
        if ($hover == "no_with_pop_up") $html .= '<a href="' . $featured_image . '" data-rel="prettyPhoto[' . $slug_list_ . ']"><img src="' . $featured_image . '" alt="' . $title . '" /></a>';
        ...
        {
            if ($hover == "no_with_pop_up") $html .= '<div class="col' . $columns . ' item-info"><h3 class="title"><a href="' . $featured_image . '" data-rel="prettyPhoto[' . $slug_list . ']">' . $title . '</a></h3></div>';
